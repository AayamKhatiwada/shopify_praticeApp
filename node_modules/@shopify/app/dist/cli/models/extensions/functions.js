...
import { toml, file, path, error, system } from '@shopify/cli-kit';
...
export class FunctionInstance {
    constructor(config, metadata, specification, directory) {
        this.config = config;
 ...
 */
export async function loadFunction(configPath) {
    ...
    if (!spec)
        return err('invalid_function_type');
    // Parse Config file
    let config;
    try {
