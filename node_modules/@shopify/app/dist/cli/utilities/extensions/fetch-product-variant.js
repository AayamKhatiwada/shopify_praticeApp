...
const NoProductsError = (storeFqdn) => {
    return new error.Abort('Could not find a product variant', `Your store needs to have at least one product to test a ${mapExtensionTypeToExternalExtensionType('checkout_ui_extension')}\n
