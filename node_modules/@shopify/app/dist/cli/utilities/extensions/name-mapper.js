export function mapExtensionTypesToExternalExtensionTypes(extensionTypes) {
    return extensionTypes.map(mapExtensionTypeToExternalExtensionType);
}
export function mapExtensionTypeToExternalExtensionType(extensionType) {
...
export function mapUIExternalExtensionTypeToUIExtensionType(externalExtensionType) {
...
export function mapExternalExtensionTypeToExtensionType(externalExtensionType) {
    switch (externalExtensionType) {
        case 'post_purchase_ui':
            return 'checkout_post_purchase';
        case 'checkout_ui':
