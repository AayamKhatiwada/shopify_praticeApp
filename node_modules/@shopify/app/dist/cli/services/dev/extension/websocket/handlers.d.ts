...
export declare function websocketUpgradeHandler(wss: WebSocketServer, options: SetupWebSocketConnectionOptions): (req: http.IncomingMessage, socket: Duplex, head: Buffer) => void;
