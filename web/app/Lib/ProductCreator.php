...
class ProductCreator
{
                ...
                [
                    ...
                    "variables" => [
                        "input" => [
                            ...
                            // "product_type" => self::randomProductType(),
    ...
    private static function randomProductType()
    {
        $noun = self::NOUNS[mt_rand(0, count(self::NOUNS) - 1)];
    ...
    private static function randomStatus()
    {
        $status = self::STATUS[mt_rand(0, count(self::STATUS) - 1)];
